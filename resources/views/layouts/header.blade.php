...
<nav class="navbar-desktop" aria-label="Navigazione principale">
  ...
  <div class="navbar-inner">
    ...
    <div class="navbar-actions">
      <button class="search" type="button" aria-label="Apri ricerca" aria-haspopup="dialog" aria-expanded="false"
        aria-controls="search-modal" data-search-open>
      ...
      <a class="cart" href="cart.php" aria-label="Open cart">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M2.1745 4.5H4.5008L6.57217 14.9282H20.0031" stroke="#1A1A1A" stroke-width="1.5"
            stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M8.41967 12.054H19.1462L20.0034 7.00684H7.49896L8.41967 12.054Z" stroke="#1A1A1A" stroke-width="1.5"
            stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
        <span class="cart-badge" aria-label="Articoli nel carrello">0</span>
      </a>
  ...
  <div class="dropdown-menu dropdown-menu--full hidden" data-dropdown-menu="saldi">
    <div class="dropdown-menu-full-inner">
      ...
      <div class="dropdown-menu-full-products dropdown-menu-full-products--single">
        @foreach (($dropdownSaldiFeatured ?? []) as $index => $product)
          @php
  ...
  <div class="dropdown-menu dropdown-menu--full hidden" data-dropdown-menu="stampanti">
    <div class="dropdown-menu-full-inner">
      ...
      <div class="dropdown-menu-full-products">
        @foreach (($dropdownPrinters ?? []) as $index => $product)
          @php
            $productName = $product->name;
            $productSubtitle = $product->subtitle;
  ...
  <div class="dropdown-menu dropdown-menu--full hidden" data-dropdown-menu="ams">
    <div class="dropdown-menu-full-inner">
      ...
      <div class="dropdown-menu-full-products">
        @foreach (($dropdownAms ?? []) as $product)
          @php
            $productName = $product->name;
            $productSubtitle = $product->subtitle;
      ...
      <div class="dropdown-menu-filaments-content">
        <div class="dropdown-menu-filaments-section">
          ...
          <div class="dropdown-menu-filaments-grid">
            @foreach (($dropdownFilaments ?? collect())->take(2) as $index => $product)
              @php
                $productName = $product->name;
                $productSubtitle = $product->subtitle;
                $productImage = $product->image_path !== '' ? $product->image_path : 'img/filamenti.png';
        ...
        <div class="dropdown-menu-filaments-section">
          <h3>Fascio</h3>
          <div class="dropdown-menu-filaments-grid">
            @foreach (($dropdownFilaments ?? collect())->slice(2, 2) as $product)
              @php
                $productName = $product->name;
                $productSubtitle = $product->subtitle;
                $productImage = $product->image_path !== '' ? $product->image_path : 'img/filamenti.png';
  ...
  <div class="dropdown-menu dropdown-menu--full hidden" data-dropdown-menu="accessori">
    <div class="dropdown-menu-full-inner dropdown-menu-full-inner--accessories">
      ...
      <div class="dropdown-menu-full-products dropdown-menu-full-products--accessories">
        @foreach (($dropdownAccessories ?? []) as $product)
          @php
            $productName = $product->name;
            $productSubtitle = $product->subtitle;
  ...
  <div class="dropdown-menu dropdown-menu--full hidden" data-dropdown-menu="makersupply">
    <div class="dropdown-menu-full-inner dropdown-menu-full-inner--makersupply">
      ...
      <div class="dropdown-menu-full-products dropdown-menu-full-products--makersupply">
        @foreach (($dropdownMakerSupply ?? []) as $product)
          @php
            $productName = $product->name;
            $productSubtitle = $product->subtitle;
...
<div class="search-modal hidden" id="search-modal" role="dialog" aria-modal="true" aria-labelledby="search-modal-title">
  ...
  <div class="search-modal-panel">
    ...
    <div class="search-modal-field">
      ...
      <input class="search-modal-input" type="search" placeholder="Cerca stampanti, filamenti, accessori..."
        autocomplete="off">
    </div>
