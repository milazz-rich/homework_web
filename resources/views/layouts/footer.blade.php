    ...
    <div class="footer-grid">
      <div class="footer-column">
        ...
        <ul class="footer-list">
          <li><a href="{{ url('/saldi') }}">🔥Saldi</a></li>
          <li><a href="{{ url('/3d-printer') }}">Stampanti</a></li>
          <li><a href="{{ url('/ams') }}">AMS</a></li>
          <li><a href="{{ url('/filamenti') }}">Filamenti</a></li>
          <li><a href="{{ url('/accessori') }}">Accessori</a></li>
          <li><a href="{{ url('/materiali') }}">Materiale</a></li>
          <li><a href="/it/pages/spare-parts">Pezzi di ricambio</a></li>
          <li><a href="{{ url('/makersupply') }}">Maker's Supply</a></li>
      ...
      <div class="footer-column footer-column-info">
        ...
        <div class="footer-text">
          <p>Bambu Lab è un'azienda di tecnologia di consumo che si concentra sulle stampanti 3D desktop. A partire
            dalla serie X1, Bambu Lab costruisce stampanti 3D all'avanguardia che abbattono le barriere tra il mondo
            digitale e quello fisico, portando la creatività a un livello completamente nuovo.</p>
        </div>
        <ul class="footer-social">
          <li><a href="https://www.facebook.com/groups/bambulabofficialusers" target="_blank" rel="noopener"
              aria-label="Facebook"><svg viewBox="0 0 9 17" aria-hidden="true">
                <path
          ...
          <li><a href="https://www.reddit.com/r/BambuLab" target="_blank" rel="noopener" aria-label="Reddit"><svg
          ...
          <li><a href="https://twitter.com/BambulabGlobal" target="_blank" rel="noopener" aria-label="Twitter"><svg
                viewBox="0 0 32 26" aria-hidden="true">
                <path
          ...
          <li><a href="https://www.instagram.com/bambulab_official" target="_blank" rel="noopener"
              aria-label="Instagram"><svg viewBox="0 0 32 32" aria-hidden="true">
                <path
          ...
          <li><a href="https://www.youtube.com/channel/UCDF3Sd2LNAsa-nKD17Jq3mw" target="_blank" rel="noopener"
              aria-label="YouTube"><svg viewBox="0 0 33 32" aria-hidden="true">
                <path
