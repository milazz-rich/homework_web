...
<main class="catalog-page">
  ...
  <h1 class="catalog-title">Filamenti</h1>

  <div class="catalog-banner">
    <div class="catalog-banner-text">
      <p class="catalog-banner-heading">Quale filamento è giusto per me?</p>
      <p class="catalog-banner-sub">Scopri il materiale più adatto alle tue stampe e al tuo progetto.</p>
      <a href="https://eu.store.bambulab.com/it/pages/bambu-filament-overview" class="catalog-banner-cta">Aiutami a scegliere &gt;</a>
    </div>
    <div class="catalog-banner-img-wrap">
      <img src="img/filamenti.png" alt="Filamenti Bambu Lab" class="catalog-banner-img">
    </div>
  </div>
  ...
  <div class="catalog-content">
    <aside class="catalog-sidebar">
      <div class="filter-group">
        ...
        <ul class="filter-list">
          <li><a href="#">PLA</a></li>
          <li><a href="#">PETG</a></li>
          <li><a href="#">ABS & ASA</a></li>
          <li><a href="#">PC & TPU</a></li>
          <li><a href="#">PA/PET</a></li>
          <li><a href="#">Fiber Reinforced</a></li>
    ...
    <div class="catalog-grid">
      <?php foreach ($products as $product): ?>
        ...
        $imagePath = $product->getImagePath() !== '' ? $product->getImagePath() : 'img/filamenti.png';
        ?>
