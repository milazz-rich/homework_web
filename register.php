...
<body>
  ...
  <div class="card">
    ...
    <form action="app/api/api_register.php" method="post">
      <div class="form-group">
        <input type="text" name="nome" placeholder="Nome*" value="<?php echo htmlspecialchars($_POST['nome'] ?? ''); ?>" required>
      </div>

      <div class="form-group">
        <input type="text" name="cognome" placeholder="Cognome*" value="<?php echo htmlspecialchars($_POST['cognome'] ?? ''); ?>" required>
      </div>

      <div class="form-group">
        <input type="email" name="email" placeholder="Indirizzo e-mail*" value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>" required>
      </div>
