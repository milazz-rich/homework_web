...
<main class="catalog-page">
  ...
  <h1 class="catalog-title">AMS</h1>

  <div class="catalog-banner">
    <div class="catalog-banner-text">
      <p class="catalog-banner-heading">Sistema automatico materiali</p>
      <p class="catalog-banner-sub">Scopri AMS, AMS lite, AMS HT e AMS 2 Pro per multi-materiale e asciugatura.</p>
      <a href="https://eu.store.bambulab.com/it/collections/all-ams" class="catalog-banner-cta">Aiutami a scegliere &gt;</a>
    </div>
    <div class="catalog-banner-img-wrap">
      <img src="img/ams2pro.png" alt="AMS Bambu Lab" class="catalog-banner-img">
    </div>
  </div>
  ...
  <div class="catalog-content">
    <aside class="catalog-sidebar">
      <div class="filter-group">
        ...
        <ul class="filter-list">
          <li><a href="#">AMS</a></li>
          <li><a href="#">AMS lite</a></li>
          <li><a href="#">AMS HT</a></li>
          <li><a href="#">AMS 2 Pro</a></li>
        </ul>
      </div>
    </aside>
    ...
    <div class="catalog-grid">
      <?php foreach ($products as $product): ?>
        ...
        $imagePath = $product->getImagePath() !== '' ? $product->getImagePath() : 'img/ams2pro.png';
        ?>
