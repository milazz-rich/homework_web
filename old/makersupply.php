...
<main class="catalog-page">
  ...
  <h1 class="catalog-title">Maker's Supply</h1>

  <div class="catalog-banner">
    <div class="catalog-banner-text">
      <p class="catalog-banner-heading">Tutto per i tuoi progetti creativi</p>
      <p class="catalog-banner-sub">Kit, componenti e materiali selezionati per MakerLab e hardware creativo.</p>
      <a href="https://eu.store.bambulab.com/it/maker-supply" class="catalog-banner-cta">Aiutami a scegliere &gt;</a>
    </div>
    <div class="catalog-banner-img-wrap">
      <img src="img/makersuppy1.png" alt="Maker's Supply Bambu Lab" class="catalog-banner-img">
    </div>
  </div>
  ...
  <div class="catalog-content">
    <aside class="catalog-sidebar">
      <div class="filter-group">
        ...
        <ul class="filter-list">
          <li><a href="#">MakerLab</a></li>
          <li><a href="#">Modelli</a></li>
          <li><a href="#">Combo kit</a></li>
    ...
    <div class="catalog-grid">
      <?php foreach ($products as $product): ?>
        ...
        $imagePath = $product->getImagePath() !== '' ? $product->getImagePath() : 'img/makersuppy1.png';
        ?>
