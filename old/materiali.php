...
<main class="catalog-page">
  ...
  <h1 class="catalog-title">Materiali</h1>

  <div class="catalog-banner">
    <div class="catalog-banner-text">
      <p class="catalog-banner-heading">Materiali per taglio e creazione</p>
      <p class="catalog-banner-sub">Legni, acrilici, vinili e altre superfici per i tuoi progetti.</p>
      <a href="https://eu.store.bambulab.com/it/collections/bambu-material" class="catalog-banner-cta">Aiutami a scegliere &gt;</a>
    </div>
    <div class="catalog-banner-img-wrap">
      <img src="img/material.png" alt="Materiali Bambu Lab" class="catalog-banner-img">
    </div>
  </div>
  ...
  <div class="catalog-content">
    <aside class="catalog-sidebar">
      <div class="filter-group">
        ...
        <ul class="filter-list">
          <li><a href="#">Legno</a></li>
          <li><a href="#">Acrilico</a></li>
          <li><a href="#">Vinile</a></li>
    ...
    <div class="catalog-grid">
      <?php foreach ($products as $product): ?>
        ...
        $imagePath = $product->getImagePath() !== '' ? $product->getImagePath() : 'img/material.png';
        ?>
