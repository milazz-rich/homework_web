      ...
      <div class="footer-grid">
        ...
        <div class="footer-column footer-column-info">
          ...
          <ul class="footer-social">
            <li>
              <a href="https://www.facebook.com/groups/bambulabofficialusers" target="_blank" rel="noopener" aria-label="Facebook">
            ...
            <li>
              <a href="https://www.instagram.com/bambulab_official" target="_blank" rel="noopener" aria-label="Instagram">
                <svg viewBox="0 0 32 32" aria-hidden="true">
            ...
            <li>
              <a href="https://www.youtube.com/channel/UCDF3Sd2LNAsa-nKD17Jq3mw" target="_blank" rel="noopener" aria-label="YouTube">
