  ...
  <main class="catalog-page">
    ...
    <div class="catalog-banner">
      <div class="catalog-banner-text">
        ...
        <a href="https://eu.store.bambulab.com/it/questionnaire/printer-quiz" class="catalog-banner-cta">Aiutami a scegliere &gt;</a>
      </div>
        ...
        <?php foreach ($products as $product): ?>
          ...
          <a href="product.php?id=<?= urlencode((string) $product->getId()) ?>" class="catalog-card">
            ...
            <div class="catalog-card-info">
              ...
              <p class="catalog-card-price">Da <strong><?= htmlspecialchars($price, ENT_QUOTES, 'UTF-8') ?> € EUR</strong></p>
            </div>
          </a>
        <?php endforeach; ?>
